...
/// </summary>
public static class SimplexNoiseUtil
{
    ...
    {
        return Generate(x * scale) * .5f + .5f;
    }

    public static float CalcPixel2D(int x, int y, float scale)
    {
        return Generate(x * scale, y * scale) * .5f + .5f;
    }

    public static float CalcPixel3D(int x, int y, int z, float scale)
    {
        return Generate(x * scale, y * scale, z * scale) * .5f + .5f;
    }

    static SimplexNoiseUtil()
    {

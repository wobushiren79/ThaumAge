...
{
    public override void SetData(Chunk chunk, BlockTypeEnum blockType, Vector3Int localPosition, DirectionEnum direction)
    {
        base.SetData(chunk, blockType, localPosition, direction);
